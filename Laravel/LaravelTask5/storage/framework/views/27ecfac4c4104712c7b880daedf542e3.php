<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <a class="navbar-brand <?php echo e(Request::is('home') ? 'active' : ''); ?>" href="<?php echo e(route('home')); ?>">Home</a>
        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="usersDropdown">
                    <a class="dropdown-item <?php echo e(Request::is('users/index') ? 'active' : ''); ?>" href="<?php echo e(route('users.index')); ?>">Users List</a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="postsDropdown">
                    <a class="dropdown-item <?php echo e(Request::is('posts/index') ? 'active' : ''); ?>" href="<?php echo e(route('posts.index')); ?>">Posts List</a>
...
<?php /**PATH D:\xxamp\htdocs\LaravelTask2\resources\views/includes/navbar.blade.php ENDPATH**/ ?>